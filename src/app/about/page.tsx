        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-2 gap-10">
            ...
            <div className="tsf-about-content">
              ...
              <p className="tsf-font-sora mt-5 text-xl/8">Discover excellence in every bite with Three Star Foods Pvt. Ltd.<br></br>
                ...
                At Three Star Foods, we're not just about products; we're about forging enduring relationships built on trust, quality, and reliability. Experience the epitome of taste and satisfaction, all at competitive prices.</p>
            </div>
          </div>
        </div>
      </div>
