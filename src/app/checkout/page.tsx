            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="border rounded-md p-4">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-32 h-32 rounded-md overflow-hidden bg-gray-50 flex items-center justify-center">
                      <Image src="/images/payment-qr.png" alt="payment-qr" width={128} height={128} className="object-contain" />
                    </div>
                    <div className="text-sm">
                      <div className="mb-2"><span className="font-semibold">Account Name:</span> 3 Star Foods Pvt. Ltd.</div>
                      <div className="mb-2"><span className="font-semibold">Account No:</span> 12345678901234</div>
