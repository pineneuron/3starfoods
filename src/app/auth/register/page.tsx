    ...
    <div className="w-full max-w-lg mx-auto my-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
      ...
      {step === "form" ? (
        <form className="space-y-6" onSubmit={handleSendCode}>
          ...
          <button type="submit" disabled={sendingCode} className="w-full py-2 bg-[#030e55] text-white rounded font-bold cursor-pointer transition-colors disabled:opacity-50">
            {sendingCode ? "Sending code..." : "Verify Email"}
          </button>
        </form>
      ) : (
        <form className="space-y-6" onSubmit={handleVerifyAndRegister}>
          ...
          <div className="flex gap-3">
            ...
            <button type="submit" disabled={loading || verificationCode.length !== 6} className="flex-1 py-2 bg-[#030e55] text-white rounded font-bold cursor-pointer transition-colors disabled:opacity-50">
