        ...
        <div className="w-full max-w-full mx-auto px-10 2xl:max-w-screen-2xl">
          ...
          <div className="grid grid-cols-6 gap-8">
            <div className="tsf-category-item mt-10 m-auto text-center">
              <Link href="/products">
                <div className="rounded-full">
                  <Image src="/images/category01.svg" className="bg-white rounded-full" alt="category01" width={60} height={60} />
                </div>
            ...
            <div className="tsf-category-item mt-10 m-auto text-center">
              <Link href="/products">
                <div className="rounded-full">
                  <Image src="/images/category02.svg" className="bg-white rounded-full" alt="category02" width={60} height={60} />
                </div>
            ...
            <div className="tsf-category-item mt-10 m-auto text-center">
              <Link href="/products">
                <div className="rounded-full">
                  <Image src="/images/category03.svg" className="bg-white rounded-full" alt="category03" width={60} height={60} />
                </div>
            ...
            <div className="tsf-category-item mt-10 m-auto text-center">
              <Link href="/products">
                <div className="rounded-full">
                  <Image src="/images/category04.svg" className="bg-white rounded-full" alt="category04" width={60} height={60} />
                </div>
            ...
            <div className="tsf-category-item mt-10 m-auto text-center">
              <Link href="/products">
                <div className="rounded-full">
                  <Image src="/images/category05.svg" className="bg-white rounded-full" alt="category05" width={60} height={60} />
                </div>
            ...
            <div className="tsf-category-item mt-10 m-auto text-center">
              <Link href="/products">
                <div className="rounded-full">
                  <Image src="/images/category06.svg" className="bg-white rounded-full" alt="category06" width={60} height={60} />
                </div>
